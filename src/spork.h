...
// Copyright (c) 2016-2017 The OHMC developers
...
#define SPORK_17_MN_WINNER_MINIMUM_AGE 10016
#define SPORK_19_TIERED_KN 10018
...
#define SPORK_16_NEW_PROTOCOL_ENFORCEMENT_3_DEFAULT 4070908800    //OFF
#define SPORK_17_MN_WINNER_MINIMUM_AGE_DEFAULT 8000               // Age in seconds. This should be > KARMANODE_REMOVAL_SECONDS to avoid
                                                                  // misconfigured new nodes in the list. 
                                                                  // Set this to zero to emulate classic behaviour
#define SPORK_19_TIERED_KN_DEFAULT 1537379010    // Block timestamp
